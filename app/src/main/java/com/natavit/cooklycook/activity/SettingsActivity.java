...
//                Toast.makeText(preference.getContext(), stringValue + " " + foodName, Toast.LENGTH_SHORT).show();
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            EditTextPreference myPref = (EditTextPreference) findPreference(getString(R.string.pref_food_key));
            myPref.setOnPreferenceClickListener(moveCursorToEndClickListener);
